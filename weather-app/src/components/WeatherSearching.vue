<template>
  <div >
    <div class="header container md:h-screen p-5 bg-yellowish-black rounded-lg text-dark-text-color text-center mt-5">
 ...
 <button @click="searchCurrentLocationWeather" class="mt-4 px-4 py-2 bg-color text-white rounded w-full ">
...
.or-line-container {
  ...
  .bg-yellowish-black {
  background-color: #A3C1AD; /* You can adjust the hex code based on your preference */
}
.bg-color{
